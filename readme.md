...
- Implementing a linked list with features outlined [here.](https://www.theodinproject.com/lessons/javascript-linked-lists)
...
- `findHead()` returns the first node in the list
- `findTail()` returns the last node in the list
